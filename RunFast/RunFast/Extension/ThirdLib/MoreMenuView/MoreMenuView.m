...
#define kFinishButtonHeight     50.0f
#define kOptionTableViewHieght  170.0f
...
- (void)initFinishButton
{
    ...
    [_finishButton setBackgroundColor:BSEA];
...
- (UITableViewCell *)tableViewCellForViewMode
{
    ...
    _viewModeSeg.tintColor = CBLUE;
    [_viewModeSeg setFrame:CGRectMake(160, (kTableViewCellHeight - 40)/2.0, 150, 40)];
...
- (UITableViewCell *)tableViewCellForNightType
{
    ...
    _nightTypeSeg.tintColor=CBLUE;
    _nightTypeSeg.frame = CGRectMake(160, (kTableViewCellHeight - 40)/2.0, 150, 40);
